...
import com.example.shopsnearby.SecurityConfig.userDetails.UserDetailsServiceImp;
		...
		// TODO Auto-generated method stub
		  try {
	            ...
	            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
	                Long userId = tokenProvider.getIdUserFromJwt(jwt);
	                
	                UserDetails userDetails = userDetailsImp.loadUserById(userId);
